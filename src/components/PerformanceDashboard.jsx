    ...
    <div className="performance-dashboard">
      ...
      <div className="overall-stats">
        ...
        <div className="stat-card">
          ...
          <p>({performanceData.total_quiz_possible / 5} quizzes completed)</p>
        </div>
        ...
        {performanceData.module_scores.map(module => (
          <div key={module.module_id} className="module-performance">
            ...
            <div className="module-stats">
              <span>Quiz Score: {module.quiz_score}/{module.total_possible}</span>
            ...
            <p className="quiz-count">
              ({module.total_possible / 5} quizzes in this module)
            </p>
          </div>
        ))}
      </div>
